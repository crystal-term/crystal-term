...
| 019 | [SPIKE: Windows CI](019-windows-ci-spike.md) | P3 | M | 001 (operator) | all submodules, root | TODO |
| 020 | [SPIKE: `term` umbrella shard](020-term-umbrella-spike.md) | P3 | S-M | — | root (prototype only) | TODO |
